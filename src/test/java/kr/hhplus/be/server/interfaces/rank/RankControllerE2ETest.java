...
class RankControllerE2ETest extends E2EControllerTestSupport {
    ...
    void getRanks() {
        // given
        Product product1 = Product.create("상품1", 100_000L, SellingStatus.SELLING);
        Product product2 = Product.create("상품2", 200_000L, SellingStatus.SELLING);
        Product product3 = Product.create("상품3", 300_000L, SellingStatus.SELLING);
        Product product4 = Product.create("상품4", 400_000L, SellingStatus.SELLING);
        Product product5 = Product.create("상품5", 500_000L, SellingStatus.SELLING);
