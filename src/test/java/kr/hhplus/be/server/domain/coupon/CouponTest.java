...
class CouponTest {
    ...
    void createCoupon_success() {
        Coupon coupon = Coupon.of(
                "10% 할인쿠폰", DiscountType.PERCENTAGE,
    ...
    void createCoupon_fail_invalidDiscountAmount() {
        assertThatThrownBy(() -> Coupon.of(
                "잘못된 쿠폰", DiscountType.PERCENTAGE,
                BigDecimal.ZERO, 100,
                LocalDateTime.now().minusDays(1),
    ...
    void createCoupon_fail_invalidMaxCapacity() {
        assertThatThrownBy(() -> Coupon.of(
                "용량 부족 쿠폰", DiscountType.FIXED_AMOUNT,
    ...
    void issueCoupon_success() {
        Coupon coupon = Coupon.of(
                "발급용 쿠폰", DiscountType.FIXED_AMOUNT,
    ...
    void issueCoupon_fail_inactive() {
        Coupon coupon = Coupon.of(
                "비활성 쿠폰", DiscountType.FIXED_AMOUNT,
    ...
    void isValidNow_fail_expired() {
        Coupon coupon = Coupon.of(
                "기간 지난 쿠폰", DiscountType.PERCENTAGE,
                BigDecimal.valueOf(5), 10,
